...
############################################################
app_settings = list()
app_settings$apptitle = "SHORTTITLE" # Title of app, to be displayed on top of analyze tab
...
app_settings$toRegister = data.frame(	
	"longname" = c(...),  # TODO 2: Create a list of display names of the quanity to register to columns.
	"shortname" = c(...) # TODO 3: Create a corresponding list of shortname (must be valid variable names) for each longname.
)
...
app_settings$lineup_generation_fn = # TODO 6: Define a lineup generation function and reference it here
app_settings$plot_generation_fn = # TODO 7: Define a plot generation function and reference it here.
