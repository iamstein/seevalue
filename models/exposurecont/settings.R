############################################################
#This is a file for the Exposure-Continuous Response setup.
...
app_settings$lineup_generation_fn = get_exposure_continuous_response_lineup
app_settings$plot_generation_fn = show_exposure_continuous_lineup

## Preload
app_settings$preload_file = list("datapath"="vignette_data/elassaiss_schaap_fig_1_digitized.csv")
app_settings$toRegister$preload_columns = c("measured_plasma_conc", "il2_stim_ratio") 
app_settings$preload_plot_settings = c("logx")